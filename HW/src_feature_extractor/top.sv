...
//    output logic [7 : 0]  features_conv3 [31 : 0]
    ...
    localparam string MEMORY_DIR_PATH = {"/home/pwz/Downloads/new_weights/"};

    // Parameters for each convolutional layer
    localparam ZERO_POINT_CONV1 = 127;
    localparam MULTIPLIER_OUT_CONV1 = 26075278;
    localparam int SCALE_IN_CONV1 [2:0] = {127, 85, 42};

    localparam ZERO_POINT_IN_CONV2 = ZERO_POINT_CONV1;
    localparam ZERO_POINT_OUT_CONV2 = 128;
    localparam MULTIPLIER_OUT_CONV2 = 21909048;
    localparam SCALE_IN_CONV2 = 42;
    localparam ZERO_POINT_WEIGHT_CONV2 = 145;
    localparam string INIT_PATH_CONV2 = {MEMORY_DIR_PATH, "conv2.mem"};

    localparam ZERO_POINT_IN_CONV3 = ZERO_POINT_OUT_CONV2;
    localparam ZERO_POINT_OUT_CONV3 = 124;
    localparam MULTIPLIER_OUT_CONV3 = 19457116;
    localparam SCALE_IN_CONV3 = 25;
    localparam ZERO_POINT_WEIGHT_CONV3 = 131;
    localparam string INIT_PATH_CONV3 = {MEMORY_DIR_PATH, "conv3.mem"};

    localparam ZERO_POINT_IN_CONV4 = ZERO_POINT_OUT_CONV3;
    localparam ZERO_POINT_OUT_CONV4 = 129;
    localparam MULTIPLIER_OUT_CONV4 = 23313294;
    localparam SCALE_IN_CONV4 = 23;
    localparam ZERO_POINT_WEIGHT_CONV4 = 108;
    localparam string INIT_PATH_CONV4 = {MEMORY_DIR_PATH, "conv4.mem"};

    localparam ZERO_POINT_IN_CONV5 = ZERO_POINT_OUT_CONV4;
    localparam ZERO_POINT_OUT_CONV5 = 107;
    localparam MULTIPLIER_OUT_CONV5 = 20695186;
    localparam SCALE_IN_CONV5 = 23;
    localparam ZERO_POINT_WEIGHT_CONV5 = 108;
    ...
    logic signed [graph_pkg::PRECISION:0] weights_conv1 [15:0][2:0];
    initial begin
        weights_conv1[0] = {-112, -56, 47};
        weights_conv1[1] = {72, -74, -31};
        weights_conv1[2] = {94, 80, 86};
        weights_conv1[3] = {-65, 95, 14};
        weights_conv1[4] = {74, -90, 11};
        weights_conv1[5] = {-16, 100, -33};
        weights_conv1[6] = {-71, -73, 79};
        weights_conv1[7] = {44, 104, -94};
        weights_conv1[8] = {-61, -55, 124};
        weights_conv1[9] = {66, -62, -102};
        weights_conv1[10] = {-69, 89, 82};
        weights_conv1[11] = {-60, 62, -117};
        weights_conv1[12] = {82, -15, 94};
        weights_conv1[13] = {6, -75, -128};
        weights_conv1[14] = {119, -40, 29};
        weights_conv1[15] = {-27, -86, 94};
    end

    const logic signed [31:0] bias_conv1 [15:0] = {1534, -401, 324, -93, 94, 561, 209, -245, 1487, 182, 90, -166, 756, 1670, -732, 257};
   ...
   async_conv #(
    ...
    logic [DATA_WIDTH_CONV2-1 : 0]  conv4_read;
    logic [$clog2(16*16*3) : 0]     conv4_read_addr;
    logic                           conv4_clean;
    logic                           conv4_switch;
    logic [1:0]                     conv4_in_mem_ptr;
    logic                           conv4_ena;
    ...
    logic [DATA_WIDTH_CONV4-1 : 0]    conv5_read;
    logic [$clog2(16*16*3) : 0]     conv5_read_addr;
    logic                             conv5_clean;
    logic                             conv5_switch;
    logic [1:0]                       conv5_in_mem_ptr;
    logic                             conv5_ena;

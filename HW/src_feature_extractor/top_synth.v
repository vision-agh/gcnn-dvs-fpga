module top_synth #(
    ...
    parameter MAX_X_COORD    = 256,
    parameter MAX_Y_COORD    = 256,

    // Timestamp and coordinate values precision
    parameter INPUT_BIT_TIME = 34,
    parameter INPUT_BIT_X    = 14,
    parameter INPUT_BIT_Y    = 14
)( 
    ...
    output [31 : 0]  out_data,     // Output feature map element data
    output          out_valid     // The is_valid flag for output feature map
);

    assign out_data[31:8] = 0;

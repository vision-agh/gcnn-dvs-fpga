...
module top #(
    ...
    parameter int DATA_WIDTH_MAXPOOL1 = (18*graph_pkg::PRECISION) + (9*2),
    parameter int ADDR_WIDTH_MAXPOOL1 = $clog2(32*32),
    parameter int ADDR_WIDTH_MAXPOOL2 = $clog2(16*16),
    parameter int DATA_WIDTH_CONV2 = (36*graph_pkg::PRECISION) + (9*2),
    parameter int DATA_WIDTH_CONV3 = (63*graph_pkg::PRECISION) + (9*2),
    parameter int DATA_WIDTH_CONV4 = (72*graph_pkg::PRECISION) + (9*2),
    parameter int DATA_WIDTH_CONV5 = (135*graph_pkg::PRECISION) + (9*2),
...
//    output logic [graph_pkg::PRECISION-1 :0] out_features [134 : 0],
//    output logic                             out_valid,
//    output logic [1:0]                       out_mem_ptr


//    output logic [graph_pkg::PRECISION-1 :0]                 features_out [17 : 0],
//    output graph_pkg::event_type                             event_out,
//    output graph_pkg::edge_type [graph_pkg::MAX_EDGES-1 : 0] edges_out
    ...
    localparam string MEMORY_DIR_PATH = {graph_pkg::REPO_PATH, "/HW/configs/before_prunning/"};

    // Parameters for each convolutional layer
    localparam ZERO_POINT_CONV1 = 125;
    localparam MULTIPLIER_OUT_CONV1 = 30519416;
    localparam int SCALE_IN_CONV1 [2:0] = {127, 85, 42};

    localparam ZERO_POINT_IN_CONV2 = ZERO_POINT_CONV1;
    localparam ZERO_POINT_OUT_CONV2 = 102;
    localparam MULTIPLIER_OUT_CONV2 = 31636694;
    localparam SCALE_IN_CONV2 = 39;
    localparam ZERO_POINT_WEIGHT_CONV2 = 135;
    localparam string INIT_PATH_CONV2 = {MEMORY_DIR_PATH, "conv2.mem"};

    localparam ZERO_POINT_IN_CONV3 = ZERO_POINT_OUT_CONV2;
    localparam ZERO_POINT_OUT_CONV3 = 109;
    localparam MULTIPLIER_OUT_CONV3 = 34135268;
    localparam SCALE_IN_CONV3 = 21;
    localparam ZERO_POINT_WEIGHT_CONV3 = 134;
    localparam string INIT_PATH_CONV3 = {MEMORY_DIR_PATH, "conv3.mem"};

    localparam ZERO_POINT_IN_CONV4 = ZERO_POINT_OUT_CONV3;
    localparam ZERO_POINT_OUT_CONV4 = 130;
    localparam MULTIPLIER_OUT_CONV4 = 44742508;
    localparam SCALE_IN_CONV4 = 17;
    localparam ZERO_POINT_WEIGHT_CONV4 = 99;
    localparam string INIT_PATH_CONV4 = {MEMORY_DIR_PATH, "conv4.mem"};

    localparam ZERO_POINT_IN_CONV5 = ZERO_POINT_OUT_CONV4;
    localparam ZERO_POINT_OUT_CONV5 = 109;
    localparam MULTIPLIER_OUT_CONV5 = 40264472;
    localparam SCALE_IN_CONV5 = 19;
    localparam ZERO_POINT_WEIGHT_CONV5 = 135;
    localparam string INIT_PATH_CONV5 = {MEMORY_DIR_PATH, "conv5.mem"};
    ...
    logic signed [graph_pkg::PRECISION:0] weights_conv1 [17:0][2:0];
    initial begin
        weights_conv1[0] = {68, 74, 88};
        weights_conv1[1] = {-86, 71, 38};
        weights_conv1[2] = {30, -116, 17};
        weights_conv1[3] = {-14, 28, -129};
        weights_conv1[4] = {-70, -29, 111};
        weights_conv1[5] = {37, 112, -60};
        weights_conv1[6] = {-106, -59, 54};
        weights_conv1[7] = {33, -79, -79};
        weights_conv1[8] = {-33, 119, 64};
        weights_conv1[9] = {-72, 55, -96};
        weights_conv1[10] = {50, -39, 105};
        weights_conv1[11] = {77, -40, -84};
        weights_conv1[12] = {125, -12, 33};
        weights_conv1[13] = {-30, -99, 68};
        weights_conv1[14] = {-22, -40, 112};
        weights_conv1[15] = {3, -39, -125};
        weights_conv1[16] = {-34, -121, -8};
        weights_conv1[17] = {-74, -70, -88};
    end

    const logic signed [31:0] bias_conv1 [17:0] = {158, -213, 1096, 978, 422, 621, 760, 777, 1597, 412, 615, 1577, 872, 1005, 612, 286, 4, 682};

    logic [graph_pkg::PRECISION-1 :0]                 features_to_maxpool1 [17 : 0];
   ...
   async_conv #(
    ...
    logic [graph_pkg::PRECISION-1 :0] conv2_out_features [35 : 0];
    logic                             conv2_wea;
    ...
    genvar j,k;
    generate
        for (k = 0; k < 36; k++) begin : conv2_data_read
    ...
    logic [graph_pkg::PRECISION-1 : 0]  features_conv3 [62 : 0];
    ...
    genvar m;
    generate
        for (m = 0; m < 72; m++) begin : conv4_data_read
    ...
    logic [7 : 0]  features_conv5 [134 : 0];
    ...
    out_serialize #(
        ...
        .ADDR_WIDTH ( ADDR_WIDTH_MAXPOOL3  ),
        .INPUT_DIM  ( 135 )
    ) u_out_serialize (
       .clk       ( clk           ),
       .reset     ( reset         ),

...
module top #(
    ...
    parameter int DATA_WIDTH_CONV3 = (60*graph_pkg::PRECISION) + (9*2),
    parameter int DATA_WIDTH_CONV4 = (42*graph_pkg::PRECISION) + (9*2),
    parameter int DATA_WIDTH_CONV5 = (132*graph_pkg::PRECISION) + (9*2),
...
//    output logic [graph_pkg::PRECISION-1 :0] out_features [131 : 0],
...
//    output graph_pkg::edge_type [graph_pkg::MAX_EDGES-1 : 0] edges_out
    ...
    localparam string MEMORY_DIR_PATH = {graph_pkg::REPO_PATH, "/HW/configs/prunning_mnist/"};

    // Parameters for each convolutional layer
    localparam ZERO_POINT_CONV1 = 31;
    localparam MULTIPLIER_OUT_CONV1 = 123052944;
    localparam int SCALE_IN_CONV1 [2:0] = {31, 21, 11};

    localparam ZERO_POINT_IN_CONV2 = ZERO_POINT_CONV1;
    localparam ZERO_POINT_OUT_CONV2 = 25;
    localparam MULTIPLIER_OUT_CONV2 = 126132816;
    localparam SCALE_IN_CONV2 = 10;
    localparam ZERO_POINT_WEIGHT_CONV2 = 33;
    ...
    localparam MULTIPLIER_OUT_CONV3 = 143243120;
    localparam SCALE_IN_CONV3 = 5;
    localparam ZERO_POINT_WEIGHT_CONV3 = 33;
    ...
    localparam MULTIPLIER_OUT_CONV4 = 183914624;
    localparam SCALE_IN_CONV4 = 4;
    localparam ZERO_POINT_WEIGHT_CONV4 = 25;
    localparam string INIT_PATH_CONV4 = {MEMORY_DIR_PATH, "conv4.mem"};

    localparam ZERO_POINT_IN_CONV5 = ZERO_POINT_OUT_CONV4;
    localparam ZERO_POINT_OUT_CONV5 = 28;
    localparam MULTIPLIER_OUT_CONV5 = 165345776;
    localparam SCALE_IN_CONV5 = 5;
    localparam ZERO_POINT_WEIGHT_CONV5 = 31;
    ...
    initial begin
        weights_conv1[0] = {17, 18, 22};
        weights_conv1[1] = {-21, 17, 10};
        weights_conv1[2] = {7, -29, 4};
        weights_conv1[3] = {-3, 7, -32};
        weights_conv1[4] = {-17, -7, 27};
        weights_conv1[5] = {9, 28, -15};
        weights_conv1[6] = {-26, -15, 13};
        weights_conv1[7] = {8, -19, -19};
        weights_conv1[8] = {-8, 29, 16};
        weights_conv1[9] = {-18, 13, -24};
        weights_conv1[10] = {12, -10, 26};
        weights_conv1[11] = {19, -10, -21};
        weights_conv1[12] = {31, -3, 8};
        weights_conv1[13] = {-8, -24, 17};
        weights_conv1[14] = {-5, -10, 28};
        weights_conv1[15] = {1, -10, -31};
        weights_conv1[16] = {-9, -30, -2};
        weights_conv1[17] = {-18, -17, -22};
    end

    const logic signed [31:0] bias_conv1 [17:0] = {24, -8, 84, 49, 21, 31, 56, 35, 111, 15, 49, 95, 57, 51, 54, 17, -4, 27};
   ...
   async_conv #(
    ...
    genvar m;
    generate
        for (m = 0; m < 42; m++) begin : conv4_data_read
    ...
    logic [5 : 0]  features_conv5 [131 : 0];

package graph_pkg;
    ...
    parameter PRECISION        = 6;                    // Precision for weights and features in GCNN model (in bits)
    parameter string REPO_PATH = "/home/pwz/Repo/gcnn-dvs-fpga";      // Path to repository (needed for memory init files)
